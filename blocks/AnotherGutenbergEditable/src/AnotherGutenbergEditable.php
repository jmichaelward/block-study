 ...
 * @since   2019-01-05
 */
class AnotherGutenbergEditable extends EditorBlock {
	/**
	 * Name of the script.
	 *
	 * @var string
	 * @since 2019-01-04
	 */
	protected $block_name = 'another-gutenberg-editable';
	...
	public function register_script() {
		wp_register_script(
			"{$this->block_name}-js",
			plugins_url( '/blocks/assets/dist/AnotherGutenbergEditable/block.js', dirname( __FILE__, 3 ) ),
